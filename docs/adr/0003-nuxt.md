...
layouts/
  ...
  admin.vue       → Optional layout
  
pages/
  index.vue       → Uses default layout
  admin/
    dashboard.vue → Can specify admin layout
```
...
Use **plain Vue** when:
- ❌ Building a component library (not an app)
- ❌ Embedding Vue into existing non-SPA app
- ❌ You need maximum control over build process
- ❌ Very simple, single-page widget
- ❌ Learning Vue fundamentals first

Use **Nuxt** when:
- ✅ Building a full application
- ✅ Need SEO (SSR/SSG)
- ✅ Want productivity and conventions
- ✅ Multi-page application
- ✅ Want modern DX without configuration
...
It's not Vue *vs* Nuxt—Nuxt **is** Vue with:
- 📁 Smart file-based conventions
- ⚡ Performance optimizations
- 🛠️ Excellent developer experience
- 🚀 Production-ready features
- 📦 Ecosystem integration

For any serious Vue application, Nuxt saves weeks of setup time and provides a battle-tested foundation. You write Vue code, but get enterprise features for free. 🎯