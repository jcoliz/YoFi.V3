...
export class PayeeMatchingRulesClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    protected processGetRules(response: Response): Promise<PaginatedResultDtoOfPayeeMatchingRuleResultDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginatedResultDtoOfPayeeMatchingRuleResultDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PaginatedResultDtoOfPayeeMatchingRuleResultDto>(null as any);
    }

    /**
     * Creates a new payee matching rule in the tenant workspace.
     * @param tenantKey The unique identifier of the tenant (from route).
     * @param rule The rule data including payee pattern, regex flag, and category.
     */
    createRule(tenantKey: string, rule: PayeeMatchingRuleEditDto): Promise<PayeeMatchingRuleResultDto> {
        let url_ = this.baseUrl + "/api/tenant/{tenantKey}/payee-rules";
        if (tenantKey === undefined || tenantKey === null)
            throw new globalThis.Error("The parameter 'tenantKey' must be defined.");
        url_ = url_.replace("{tenantKey}", encodeURIComponent("" + tenantKey));
    ...
    protected processCreateRule(response: Response): Promise<PayeeMatchingRuleResultDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
            ...
            result201 = PayeeMatchingRuleResultDto.fromJS(resultData201);
            return result201;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PayeeMatchingRuleResultDto>(null as any);
    }

    /**
     * Retrieves a specific payee matching rule by its unique key.
     * @param key The unique identifier of the rule.
     */
    getRuleById(key: string, tenantKey: string): Promise<PayeeMatchingRuleResultDto> {
        let url_ = this.baseUrl + "/api/tenant/{tenantKey}/payee-rules/{key}";
    ...
    protected processGetRuleById(response: Response): Promise<PayeeMatchingRuleResultDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PayeeMatchingRuleResultDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
     ...
     * @param key The unique identifier of the rule to update.
     * @param rule The updated rule data including payee pattern, regex flag, and category.
     */
    updateRule(key: string, tenantKey: string, rule: PayeeMatchingRuleEditDto): Promise<PayeeMatchingRuleResultDto> {
        let url_ = this.baseUrl + "/api/tenant/{tenantKey}/payee-rules/{key}";
        if (key === undefined || key === null)
            throw new globalThis.Error("The parameter 'key' must be defined.");
        url_ = url_.replace("{key}", encodeURIComponent("" + key));
    ...
    protected processUpdateRule(response: Response): Promise<PayeeMatchingRuleResultDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @param key The unique identifier of the rule to delete.
     */
    deleteRule(key: string, tenantKey: string): Promise<void> {
        let url_ = this.baseUrl + "/api/tenant/{tenantKey}/payee-rules/{key}";
        if (key === undefined || key === null)
            throw new globalThis.Error("The parameter 'key' must be defined.");
        url_ = url_.replace("{key}", encodeURIComponent("" + key));
...
export class TestControlClient {
     ...
     * @param credentialsList Collection of credentials including username, email, password
     * @return Collection of created user credentials with IDs populated
     */
    createUsersV2(credentialsList: TestUserCredentials[]): Promise<TestUserCredentials[]> {
        let url_ = this.baseUrl + "/TestControl/v2/users";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(credentialsList);
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreateUsersV2(_response);
        });
    }

    protected processCreateUsersV2(response: Response): Promise<TestUserCredentials[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
     ...
     * @param usernames Collection of usernames to delete. Must not be empty.
     * @return 204 No Content on success.
     */
    deleteUsersV2(usernames: string[]): Promise<void> {
        let url_ = this.baseUrl + "/TestControl/v2/users";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteUsersV2(_response);
        });
    }

    protected processDeleteUsersV2(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param username The username (must include __TEST__ prefix) of the user.
     * @param tenantKey The unique key of the workspace.
     * @param request The collection of transactions to create, wrapped for automatic validation.
     * @return The collection of created transactions.
     */
    seedTransactionsPrecise(username: string, tenantKey: string, request: CollectionRequestOfTransactionEditDto): Promise<TransactionResultDto[]> {
        let url_ = this.baseUrl + "/TestControl/users/{username}/workspaces/{tenantKey}/transactions/seed-precise";
        if (username === undefined || username === null)
            throw new globalThis.Error("The parameter 'username' must be defined.");
        url_ = url_.replace("{username}", encodeURIComponent("" + username));
        if (tenantKey === undefined || tenantKey === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSeedTransactionsPrecise(_response);
        });
    }

    protected processSeedTransactionsPrecise(response: Response): Promise<TransactionResultDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
     ...
     * @param username The username (must include __TEST__ prefix) of the user.
     * @param tenantKey The unique key of the workspace.
     * @param count (optional) Number of import review transactions to create.
     * @param selectedCount (optional) Number of transactions to mark as selected. Defaults to all transactions.
     * @return Count of seeded import review transactions.
     */
    seedImportReviewTransactions(username: string, tenantKey: string, count: number | undefined, selectedCount: number | null | undefined): Promise<number> {
        let url_ = this.baseUrl + "/TestControl/users/{username}/workspaces/{tenantKey}/import/seed?";
        if (username === undefined || username === null)
            throw new globalThis.Error("The parameter 'username' must be defined.");
        url_ = url_.replace("{username}", encodeURIComponent("" + username));
        if (tenantKey === undefined || tenantKey === null)
        ...
        if (selectedCount !== undefined && selectedCount !== null)
            url_ += "selectedCount=" + encodeURIComponent("" + selectedCount) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSeedImportReviewTransactions(_response);
        });
    }

    protected processSeedImportReviewTransactions(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
     ...
     * @param workspaceKeys Collection of workspace keys to delete. Must not be empty.
     * @return 204 No Content on success.
     */
    deleteWorkspaces(workspaceKeys: string[]): Promise<void> {
        let url_ = this.baseUrl + "/TestControl/workspaces";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(workspaceKeys);
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteWorkspaces(_response);
        });
    }

    protected processDeleteWorkspaces(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param request Collection of transactions to validate (but not persist).
     * @return 200 OK if validation passes, 400 Bad Request if validation fails.
     */
    validateTransactions(request: CollectionRequestOfTransactionEditDto): Promise<string> {
        let url_ = this.baseUrl + "/TestControl/validate/transactions";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processValidateTransactions(_response);
        });
    }

    protected processValidateTransactions(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class PaginatedResultDtoOfPayeeMatchingRuleResultDto implements IPaginatedResultDtoOfPayeeMatchingRuleResultDto {
    items?: PayeeMatchingRuleResultDto[];
    metadata?: PaginationMetadata;

    constructor(data?: IPaginatedResultDtoOfPayeeMatchingRuleResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(PayeeMatchingRuleResultDto.fromJS(item));
            }
            this.metadata = _data["metadata"] ? PaginationMetadata.fromJS(_data["metadata"]) : undefined as any;
        }
    }

    static fromJS(data: any): PaginatedResultDtoOfPayeeMatchingRuleResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedResultDtoOfPayeeMatchingRuleResultDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedResultDtoOfPayeeMatchingRuleResultDto {
    items?: PayeeMatchingRuleResultDto[];
    metadata?: PaginationMetadata;
}

export class PayeeMatchingRuleResultDto implements IPayeeMatchingRuleResultDto {
    key?: string;
    payeePattern?: string;
    payeeIsRegex?: boolean;
    category?: string;
    createdAt?: Date;
    modifiedAt?: Date;
    ...
    constructor(data?: IPayeeMatchingRuleResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.key = _data["key"];
            this.payeePattern = _data["payeePattern"];
            this.payeeIsRegex = _data["payeeIsRegex"];
            this.category = _data["category"];
            this.createdAt = _data["createdAt"] ? new Date(_data["createdAt"].toString()) : undefined as any;
            this.modifiedAt = _data["modifiedAt"] ? new Date(_data["modifiedAt"].toString()) : undefined as any;
            this.lastUsedAt = _data["lastUsedAt"] ? new Date(_data["lastUsedAt"].toString()) : undefined as any;
            this.matchCount = _data["matchCount"];
        }
    }

    static fromJS(data: any): PayeeMatchingRuleResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PayeeMatchingRuleResultDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["key"] = this.key;
        data["payeePattern"] = this.payeePattern;
        data["payeeIsRegex"] = this.payeeIsRegex;
        data["category"] = this.category;
        data["createdAt"] = this.createdAt ? this.createdAt.toISOString() : undefined as any;
        data["modifiedAt"] = this.modifiedAt ? this.modifiedAt.toISOString() : undefined as any;
...
export interface IPayeeMatchingRuleResultDto {
    key?: string;
    payeePattern?: string;
    payeeIsRegex?: boolean;
    category?: string;
...
export enum PayeeRuleSortBy {
    PayeePattern = 0,
    Category = 1,
    LastUsedAt = 2,
}

export class PayeeMatchingRuleEditDto implements IPayeeMatchingRuleEditDto {
    payeePattern?: string;
    payeeIsRegex?: boolean;
    category?: string;

    constructor(data?: IPayeeMatchingRuleEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): PayeeMatchingRuleEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new PayeeMatchingRuleEditDto();
        result.init(data);
        return result;
    }
...
export interface IPayeeMatchingRuleEditDto {
    payeePattern?: string;
    payeeIsRegex?: boolean;
    category?: string;
}
...
export class CollectionRequestOfTransactionEditDto implements ICollectionRequestOfTransactionEditDto {
    items?: TransactionEditDto[];

    constructor(data?: ICollectionRequestOfTransactionEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(TransactionEditDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CollectionRequestOfTransactionEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new CollectionRequestOfTransactionEditDto();
        result.init(data);
        return result;
    }
...
export interface ICollectionRequestOfTransactionEditDto {
    items?: TransactionEditDto[];
}
