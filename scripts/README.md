...
| [`Collect-CodeCoverage.ps1`](Collect-CodeCoverage.ps1) | Runs unit and controller integration tests and collects combined code coverage metrics with HTML report generation |
